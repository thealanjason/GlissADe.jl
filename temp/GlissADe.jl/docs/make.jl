...
makedocs(;
    ...
    repo = "https://github.com/reckylurker/GlissADe.jl/blob/{commit}{path}#{line}",
    sitename = "GlissADe.jl",
    format = Documenter.HTML(; canonical = "https://reckylurker.github.io/GlissADe.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/reckylurker/GlissADe.jl")
