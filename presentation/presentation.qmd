...
## Surface Flow over Complex Surfaces

[image here: geohazard triptych, matching the old deck layout — avalanche | landslide | flash flood photos]

[image here: computational models row (OpenFOAM-Avalanche, AvaFrame, r.avaflow, ...) with an arrow into an "uncertainty informed" hazard-map result, matching the old deck layout]
