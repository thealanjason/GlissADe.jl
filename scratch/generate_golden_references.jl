...
function generate_golden_references()
    ...
    println(
        "Saved Implicit Golden Reference: test/fixtures/simpleslope_implicit_golden.jld2",
    )
    ...
    println(
        "Saved Explicit Golden Reference: test/fixtures/simpleslope_explicit_golden.jld2",
    )
    println("=========================================================================")
end
