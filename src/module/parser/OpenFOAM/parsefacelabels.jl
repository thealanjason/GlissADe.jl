...
"""
function _parsefacelabels_openfoam(location_faceLabels::String, correction_factor::INT_TYPE[])
    ...
    @inbounds @maybe_threads Threads.nthreads == 1 || !THREADS[] for i in 1:n_facelabels
